...
Snapshot as of the 2026-07-07 `agent-ref/` migration, updated 2026-07-28. Reflects `origin` branches
...
| `fix/biome-climate-mapping`        | Yes                           | Clean PR/ship candidate with no QA scaffolding: root mapping fix `bbd845c`, dynamic-banding commit `7a0491b` (the clean cherry-pick of `ad491ab`), and cached-chunk-sampler live-path fix `8d0dea5` (the clean cherry-pick of `366caae`). As the QA branch gains further work, replicate only production commits here.                                                                                                                                                                                                                              |
