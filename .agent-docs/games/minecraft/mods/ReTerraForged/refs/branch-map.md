...
Snapshot as of the 2026-07-07 `agent-ref/` migration, updated 2026-07-19. Reflects `origin` branches
...
| `qa/configurable-ocean-depth`      | Yes                           | Local only, not pushed to `origin`. QA checkpoint off `feat/configurable-ocean-depth`; carries the Trial Chambers/Ancient City fix mixin plus diagnostic-only QA mixins. See `plans/ocean-depth/trial-chambers-and-ocean-structures.md` |
