package org.squinchmods.investigate.ftf.spatial;
...
public final class FtfSpatialCompatibilityProbePack implements ProbePack {
    @Override
    public void register() {
        ProbeRegistry.register("squinch:ftf-spatial-compatibility", "1", SpatialCompatibility::new);
    }
    ...
    private static final class SpatialCompatibility implements ProbeExecution {
        ...
        private SpatialCompatibility(ProbeRequest request) {
            ...
            this.selection = new FinishedChunkSelection(config, "ftf-spatial-compatibility");
