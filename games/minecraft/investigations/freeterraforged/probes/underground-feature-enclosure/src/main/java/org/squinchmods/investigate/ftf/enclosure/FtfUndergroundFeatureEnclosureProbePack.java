package org.squinchmods.investigate.ftf.enclosure;
...
public final class FtfUndergroundFeatureEnclosureProbePack implements ProbePack {
    private static final int BUFFER_BLOCKS = UndergroundBiomeSurfaceProtection.HARD_SHELL_BLOCKS;

    @Override
    public void register() {
        ProbeRegistry.register(
            "squinch:ftf-underground-feature-enclosure",
            "1",
    ...
    private static final class UndergroundFeatureEnclosureProbe implements ProbeExecution {
        ...
        private UndergroundFeatureEnclosureProbe(ProbeRequest request) {
            this.selection = new FinishedChunkSelection(request.config(), "ftf-underground-feature-enclosure");
        ...
        public ProbeResult tick(net.minecraft.server.MinecraftServer server) throws Exception {
            ...
            FTFRandomState randomState = (FTFRandomState)(Object)level.getChunkSource().randomState();
            ...
            Class<?> guardClass = Class.forName(
                "etcodehome.freeterraforged.world.worldgen.feature.placement.UndergroundFeatureEnclosure$Guard"
            );
