package org.squinchmods.investigate.ftf.surfacerescue;
...
public final class SurfaceRescueCrashProbePack implements ProbePack {
    ...
    public void register() {
        ProbeRegistry.register("squinch:ftf-surface-rescue-crash", "1", SurfaceRescueCrashProbe::new);
    }
    ...
    private static final class SurfaceRescueCrashProbe implements ProbeExecution {
        ...
        private static JsonObject diagnose(
            ...
            Class<?> dynamicHeightRangePlacementClass = Class.forName(
                "etcodehome.freeterraforged.world.worldgen.feature.placement.DynamicHeightRangePlacement"
            );
            ...
            diagnostics.addProperty("is_ftf_generator", Class.forName(
                "etcodehome.freeterraforged.world.worldgen.runtime.TerraForgedChunkGenerator"
