...
public final class CurrentPreviewLifecycleProbePack implements ProbePack {
    ...
    public void register() {
        ProbeRegistry.register("squinch:ftf-current-preview-lifecycle-performance", "1", PreviewLifecycle::new);
    }
    ...
    private static final class PreviewLifecycle implements ProbeExecution {
        ...
        private Sample sample(
            ...
            Preset prepared = provider.lookupOrThrow(FTFRegistries.PRESET)
