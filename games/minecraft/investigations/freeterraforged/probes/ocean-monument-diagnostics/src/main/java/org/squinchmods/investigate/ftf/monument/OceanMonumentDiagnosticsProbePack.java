package org.squinchmods.investigate.ftf.monument;
...
public final class OceanMonumentDiagnosticsProbePack implements ProbePack {
    ...
    public void register() {
        ProbeRegistry.register("squinch:ftf-ocean-monument-diagnostics", "1", Diagnostics::new);
    }
    ...
    private static final class Diagnostics implements ProbeExecution {
        ...
        private Diagnostics(ProbeRequest request) {
            this.selection = new FinishedChunkSelection(request.config(), "ftf-ocean-monument-diagnostics");
