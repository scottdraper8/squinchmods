...
public final class FtfClimateDomainProbePack implements ProbePack {
    @Override
    public void register() {
        ProbeRegistry.register("squinch:ftf-climate-domain", "1", ClimateDomain::new);
    }
    ...
    private static final class ClimateDomain implements ProbeExecution {
        ...
        private ClimateDomain(ProbeRequest request) {
            ...
            this.selection = new FinishedChunkSelection(config, "ftf-climate-domain");
