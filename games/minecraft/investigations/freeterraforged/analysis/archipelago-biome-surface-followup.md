...
and their required libraries. Client/UI/rendering, map, pregeneration, and performance mods were
removed from this focused list. Dependencies embedded inside parent JARs are recorded in the focused
manifest rather than invented as separate profile entries. Its SHA-256 is
`787de6e639106e76a967d6e813ec1c953129eca9113da76579329f271d57aca2`.
...
`vb-compat` is retained with VanillaBackport's worldgen compatibility data. Other full-profile
entries such as Distant Horizons, Sodium/Iris, Xaero maps, Jade, UI helpers, Smooth Steps, Chunky,
FerriteCore, and generic client/rendering or memory/performance utilities are intentionally outside
this focused worldgen list. A complete personal launcher-profile inventory is intentionally neither
required nor retained; the focused, repository-owned manifest is the reproducible input boundary.
...
Biolith, Lithostitched, VanillaBackport, Terrain Slabs, Improved Village Placement, and their
