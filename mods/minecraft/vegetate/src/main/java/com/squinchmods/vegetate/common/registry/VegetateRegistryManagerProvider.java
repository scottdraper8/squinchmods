...
public final class VegetateRegistryManagerProvider {
  ...
  @Nullable private static RegistryAccess catalogRegistryManager;

  public static void setRegistryManager(RegistryAccess registryAccess) {
    registryManager = registryAccess;
  }

  @Nullable public static RegistryAccess getRegistryManager() {
    return registryManager;
  }

  @Nullable public static RegistryAccess getOrLoadRegistryManager() {
  ...
  @Nullable public static RegistryAccess getOrLoadCatalogRegistryManager() {
