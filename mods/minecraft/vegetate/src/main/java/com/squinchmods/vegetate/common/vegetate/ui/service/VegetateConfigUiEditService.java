...
public final class VegetateConfigUiEditService implements ConfigUiEditService {
  ...
  private @Nullable Boolean pendingDisableAllMushrooms = null;

  public VegetateConfigUiEditService(
  ...
  public boolean getDisableAllMushrooms() {
    return pendingDisableAllMushrooms != null
        ? pendingDisableAllMushrooms
        : configService.getConfig().disableAllMushrooms;
  }
  ...
  public void applyToConfig() {
    if (pendingDisableAllMushrooms != null)
      configService.getConfig().disableAllMushrooms = pendingDisableAllMushrooms;
