...
Feel free to <a href="https://discord.com/invite/QGwFvvMQCn">join our community at the discord server</a> to chat, share your creations, ask any question or to simply be updated about the latest development of the mod and notified when the new release is out. Also don't hesitate to <a href="https://github.com/SquinchMods/structurify/issues">report any crash or bug via GitHub issues</a>.

<br>

# 👋 Support

I will continue developing my mods as a hobby because I truly enjoy it. If you'd like to support me, you can do so on [Patreon](https://www.patreon.com/SquinchMods) or [Ko-fi](https://ko-fi.com/squinchmods). Your support is greatly appreciated.

<br>

# 📜 License

The mod is licensed with [CC BY-NC-ND 4.0](https://raw.githubusercontent.com/SquinchMods/structurify/master/LICENSE.txt) license.
