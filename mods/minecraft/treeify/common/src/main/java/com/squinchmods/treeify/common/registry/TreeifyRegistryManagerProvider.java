 ...
 */
public final class TreeifyRegistryManagerProvider {
    ...
    public static RegistryAccess getOrLoadRegistryManager() {
        ...
        registryManager = TreeifyResourcePackProvider.load();
        return registryManager;
    }
    ...
    public static RegistryAccess getOrLoadCatalogRegistryManager() {
        ...
        catalogRegistryManager = TreeifyResourcePackProvider.load();
        return catalogRegistryManager;
    }

    private TreeifyRegistryManagerProvider() {
    }
}
